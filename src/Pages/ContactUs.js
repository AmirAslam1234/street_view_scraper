                    ...
                    <div class="grid grid-cols-6 gap-6 ">
                      <div class="col-span-6 sm:col-span-3">
                        ...
                        <input
                          ...
                          class="mt-1 focus:ring-indigo-500 py-2 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                        />
                      </div>
                      <div class="col-span-6 sm:col-span-3">
                        <label
